...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="/index.php/Home1/Index">
			...
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">导航</li>
						<?php if(is_array($result)): foreach($result as $key=>$vo): ?><li class="li"><a href="/index.php/Home1/Walkto/index/id/<?php echo ($vo['ast_aid']); ?>"><?php echo ($vo['ast_acate']); ?></a></li><?php endforeach; endif; ?>
					</ul>
					<!--<p>广告位</p>
