					...
					<div class="lzx">
					   <div class="lbl">
						...
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><ul class="zplb">
						 ...
						 <li><a href="/index.php/Home/Work/details/id/<?php echo ($vo['w_id']); ?>">查看详情</a></li>
						</ul><?php endforeach; endif; ?>
						
				     </div>
					<div class="page_turn">
						<a href="/index.php/Home/Work/index/p/<?php if($_GET['p']-1<=0){echo 1;}else{echo $_GET['p']-1;} ?>/title/<?php if($_GET['title']){echo $_GET['title'];}?>">上一页</a>
						<a href="/index.php/Home/Work/index/p/1/title/<?php if($_GET['title']){echo $_GET['title'];}?>">1</a>
						<!--<a href="">2</a>
						<a href="">3</a>
						<a href="">4</a>-->
						
						<span>...</span>
						<a href="/index.php/Home/Work/index/p/<?php echo ($page); ?>/title/<?php if($_GET['title']){echo $_GET['title'];}?>"><?php echo ($page); ?></a>
						<a href="/index.php/Home/Work/index/p/<?php if($_GET['p']+1<$page){echo $_GET['p']+1;}else{echo $page;} ?>/title/<?php if($_GET['title']){echo $_GET['title'];}?>">下一页</a>
						<a href="/index.php/Home/Work/index/p/<?php echo ($page); ?>/title/<?php if($_GET['title']){echo $_GET['title'];}?>">尾页</a>
					</div>
					</div>
				</div>
			</div>
