		...
		<div class="center-block">
			...
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">导航</li>
						<?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><li class="li"><a href="/index.php/Home/News/index/id/<?php echo ($vo['cate_id']); ?>"><?php echo ($vo['cate_name']); ?></a></li><?php endforeach; endif; ?>
					</ul>
					<p>广告位</p>
				...
				<div class="right fr">
						...
						<?php if(is_array($list)): foreach($list as $key=>$val): ?><li class="cl">
								...
								<div class="r fl">
									<div class="title_bar cl">
										<a href="/index.php/Home/News/details/aid/<?php echo ($val['art_id']); ?>" class="fl"><?php echo ($val['art_title']); ?></a><span class="fr"><?php echo (date("Y-m-d",$val['art_addtime'])); ?></span>
									</div>
									<p>
					...
					<div class="page_turn">
						<a href="/index.php/Home/News/index/p/<?php if($_GET['p']-1>0){echo $_GET['p']-1;}else{echo 1;} ?>">上一页</a>
						<a href="/index.php/Home/News/index/p/1">1</a>
						<span>...</span>
						<a href="/index.php/Home/News/index/p/<?php echo $page; ?>"><?php echo $page; ?></a>
						
						<a href="/index.php/Home/News/index/p/<?php if($_GET['p']+1>$page){echo $page;}else{echo $_GET['p']+1;} ?>">下一页</a>
						<a href="/index.php/Home/News/index/p/<?php echo ($page); ?>">尾页</a>
					</div>
				</div>
			</div>
		</div>
