    ...
    <div class="banner">
      ...
      <div class="slide_nav"><span class="on"></span><span></span><span></span><span></span><span></span></div>
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="">首页</a>&nbsp;&gt;&gt;&nbsp;<span>招商投资</span></div>
			<div class="main_section cl">
				...
				<div class="right fr">
					<div class="title cl">
						<span class="fl">内容详情</span>
						<!--<a href="" class="fr">MORE&gt;&gt;</a>-->
					</div>
					<div class="detail">
						<p class="detail_title"><?php echo ($result['i_title']); ?></p>
						<p class="other">作者：<?php echo ($result['i_place']); ?>  日期：<?php echo ($result['i_time']); ?></p>
					...
					<a href="/index.php/Home/Invest/detail/id/<?php echo ($result1['i_id']); ?>" class="prev">上一篇：<?php if($result1['i_title']){echo $result1['i_title'];}else{echo "没有了";} ?>...</a>
					<a href="/index.php/Home/Invest/detail/id/<?php echo ($result2['i_id']); ?>" class="next">下一篇：<?php if($result2['i_title']){echo $result2['i_title'];}else{echo "没有了";} ?></a>
				</div>
			</div>
		</div>
		    <div class="footer">
