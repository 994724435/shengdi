    ...
    <div class="banner">
      ...
      <div class="slide_nav"><span class="on"></span><span></span><span></span><span></span><span></span></div>
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="">首页</a>&nbsp;&gt;&gt;&nbsp;<span>产品简介</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">导航</li>
						<?php if(is_array($recate)): foreach($recate as $key=>$vo): ?><li class="li"><a href="/index.php/Home/product/index/id/<?php echo ($vo['cate_id']); ?>"><?php echo ($vo['cate_name']); ?></a></li><?php endforeach; endif; ?>
					</ul>
					<p>广告位</p>
				...
				<div class="right fr">
					...
					<div class="detail">
						...
						<p class="p">
							<img src="<?php echo ($result['pro_thumb']); ?>" style="width: 300px;margin: 0 auto;display: <?php if($result['pro_thumb']){echo 'block';}else{echo 'none';} ?>;"/>
						 <br />
						 <p > <?php $str =stripslashes($result['pro_introduction']); echo htmlspecialchars_decode($str); ?></p>
						
						</p>
						</div>
					<a href="/index.php/Home/Product/details/id/<?php echo ($result1['pro_id']); ?>" class="prev">上一篇：<?php if($result1['pro_name']){echo $result1['pro_name'];}else{echo "没有了";} ?>...</a>
					<a href="/index.php/Home/Product/details/id/<?php echo ($result2['pro_id']); ?>" class="next">下一篇：<?php if($result2['pro_name']){echo $result2['pro_name'];}else{echo "没有了";} ?></a>
				</div>
			</div>
		</div>
		    <div class="footer">
