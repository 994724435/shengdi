...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">Current Location：<a href="/index.php/Homeen1/Index/index">Home</a>&nbsp;&gt;&gt;&nbsp;<span>News Center</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">Navigation</li>
						<?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><li class="li"><a href="/index.php/Homeen1/News/index/id/<?php echo ($vo['cate_id']); ?>"><?php echo ($vo['cate_name']); ?></a></li><?php endforeach; endif; ?>
					</ul>
				</div>
				<div class="right fr">
					<div class="tit cl">
						...
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li class="cl">    
							...
							<div class="r fl">
								<div class="title_bar cl">
									<a href="/index.php/Homeen1/News/details/id/<?php echo ($vo['art_id']); ?>" class="fl"><?php echo ($vo['art_title']); ?></a><span class="fr"><?php echo (date('Y-m-d',$vo["art_addtime"])); ?></span>
								</div>
								<p>
					...
					<div class="page_turn">
						<a href="/index.php/Homeen1/News/index/p/<?php if($_GET['p']-1>0){echo $_GET['p']-1;}else{echo 1;} ?>">Pre</a>
						<a href="/index.php/Homeen1/News/index/p/1">1</a>
						<a href="/index.php/Homeen1/News/index/p/2">2</a>
						<span>...</span>
						<a href="/index.php/Homeen1/News/index/p/<?php if($page>3){echo $page-2;}else{echo 4;} ?>"><?php if($page>3){echo $page-2;}else{echo 4;} ?></a>
						<a href="/index.php/Homeen1/News/index/p/<?php if($page>4){echo $page-1;}else{echo 5;} ?>"><?php if($page>4){echo $page-1;}else{echo 5;} ?></a>
						
						<a href="/index.php/Homeen1/News/index/p/<?php if($_GET['p']+1>$page){echo $page;}else{echo $_GET['p']+1;} ?>">Next</a>
						<a href="/index.php/Homeen1/News/index/p/<?php echo ($page); ?>">Last</a>
					</div>
				</div>
			</div>
		</div>
