...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">Current Location：<a href="/index.php/Homeen1/Index/index">Home</a>&nbsp;&gt;&gt;&nbsp;<span>Product Introduction</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">Navigation</li>
					<?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><li class="li"><a href="/index.php/Homeen1/Product/index/id/<?php echo ($vo['cate_id']); ?>"><?php echo ($vo['cate_name']); ?></a></li><?php endforeach; endif; ?>	
				...
				<div class="right fr">
					...
					<div class="page_turn">
						<a href="/index.php/Homeen1/Product/index/p/<?php if($_GET['p']-1<=0){echo 1;}else{echo $_GET['p']-1;} ?>">Pre</a>
						<a href="/index.php/Homeen1/Product/index/p/1">1</a>
						<a href="/index.php/Homeen1/Product/index/p/2">2</a>				
						<span>...</span>
						<a href="/index.php/Homeen1/Product/index/p/<?php echo ($page); ?>"><?php if($page>2){echo $page;}else{echo 'None';} ?></a>
						<a href="/index.php/Homeen1/Product/index/p/<?php if($_GET['p']+1<$page){echo $_GET['p']+1;}else{echo $page;} ?>">下一页</a>
						<a href="/index.php/Homeen1/Product/index/p/<?php echo ($page); ?>">Last</a>
					</div>
				</div>
			</div>
		</div>
