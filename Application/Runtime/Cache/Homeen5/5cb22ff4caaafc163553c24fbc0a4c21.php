...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="/index.php/Homeen5/Index/index">首页</a>&nbsp;&gt;&gt;&nbsp;<span>新闻中心</span></div>
			<div class="main_section cl">
				...
				<div class="right fr">
					...
					<a href="/index.php/Homeen5/News/details/id/<?php echo ($result1['art_id']); ?>" class="prev">上一篇：<?php if($result1['art_title']){echo $result1['art_title'];}else{echo "没有了";} ?>...</a>
					<a href="/index.php/Homeen5/News/details/id/<?php echo ($result2['art_id']); ?>" class="next">下一篇：<?php if($result2['art_title']){echo $result2['art_title'];}else{echo "没有了";} ?></a>
				</div>
			</div>
		</div>
				<div class="footer">
