		...
		<div class="center-block">
			<div class="main block1 cl">
				...
				<div class="center fl">
					...
					<div class="div1 cl">
						...
						<div class="r fl">
							<a href="/index.php/Homeen5/News/details/id/<?php echo ($news1['art_id']); ?>" class="t"><?php echo ($news1['art_title']); ?></a>
					...
					<ul>
						<?php if(is_array($news)): foreach($news as $key=>$news): ?><li><a href="/index.php/Homeen5/News/details/id/<?php echo ($news['art_id']); ?>">
			...
			<div class="main block3 cl">
				<div class="left fl">
					...
					<?php if(is_array($art)): foreach($art as $key=>$art): ?><a href="/index.php/Homeen5/News/details/id/<?php echo ($art['art_id']); ?>"><?php echo ($art['art_title']); ?></a><?php endforeach; endif; ?>
				</div>
				<div class="right fr">
					<div class="title cl">
					...
					<ul>
						<?php if(is_array($serverce)): foreach($serverce as $key=>$se): ?><li class="cl">
							...
							<div class="info fr">
								<a href="/index.php/Homeen5/News/details/id/<?php echo ($se['art_id']); ?>"><?php echo ($se['art_title']); ?></a>
								<p>
