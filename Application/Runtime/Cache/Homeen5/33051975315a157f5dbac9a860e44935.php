...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">Current Location：<a href="/index.php/Homeen5/Index">Home</a>&nbsp;&gt;&gt;&nbsp;<span>Into Sunday</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">Navigation</li>
						<?php if(is_array($result)): foreach($result as $key=>$vo): ?><li class="li"><a href="/index.php/Homeen5/Walkto/index/id/<?php echo ($vo['ast_aid']); ?>"><?php echo ($vo['ast_acate']); ?></a></li><?php endforeach; endif; ?>
					</ul>
					<!--<p>广告位</p>
