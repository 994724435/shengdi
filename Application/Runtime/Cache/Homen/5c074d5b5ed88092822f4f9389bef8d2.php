        ...
        <ul class="nav fr cl">
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="/index.php/Ho men/Work/index/title/校园招聘">Campus Recruitment</a></li>           
            </ul>
          </li>
        </ul>
      </div>
			...
			<div class="main_section cl">
				...
				<div class="right fr">
					...
					<div class="detail">
						...
						<p class="other">Author：<?php echo ($result['art_author']); ?>  Date：<?php echo (date('Y-m-d',$result['art_addtime'])); ?></p>

						<p class="p">
							<img src="<?php echo ($result['art_thumb']); ?>" style="width: 300px;margin: 0 auto;display: <?php if($result['art_thumb']){echo 'block';}else{echo 'none';} ?>;"/>
						 <br />
						 <?php $str =stripslashes($result['art_content']); echo htmlspecialchars_decode($str); ?>
						</p>
						</div>
					<a href="/index.php/Homen/News/details/aid/<?php echo ($result1['art_id']); ?>" class="prev">Pre：<?php if($result1['art_title']){echo $result1['art_title'];}else{echo "No more";} ?>...</a>
					<a href="/index.php/Homen/News/details/aid/<?php echo ($result2['art_id']); ?>" class="next">Next：<?php if($result2['art_title']){echo $result2['art_title'];}else{echo "No more";} ?></a>
				</div>
			</div>
		</div>
		    <div class="footer">
