    ...
    <div class="banner">
      ...
      <div class="slide_nav"><span class="on"></span><span></span><span></span><span></span><span></span></div>
		...
		<div class="center-block">
			<div class="location">Current location：<a href="/index.php/Homen/Index">Home</a>&nbsp;&gt;&gt;&nbsp;<span>Nees Center</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">Navigation</li>
						<?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><li class="li"><a href="/index.php/Homen/News/index/id/<?php echo ($vo['cate_id']); ?>"><?php echo ($vo['cate_name']); ?></a></li><?php endforeach; endif; ?>
						<!--<li class="li"><a href="">董事长简介</a></li>
						<li class="li"><a href="">企业文化</a></li>
				...
				<div class="right fr">
					<div class="title cl">
						<span class="fl">News list</span>
						<a href="" class="fr">MORE&gt;&gt;</a>
					</div>
					<ul>
						<?php if(is_array($list)): foreach($list as $key=>$val): ?><li class="cl">
								<div class="l fl"><img class="adapt" src="<?php echo ($val['art_thumb']); ?>"/></div>
								<div class="r fl">
									<div class="title_bar cl">
										<a href="/index.php/Homen/News/details/aid/<?php echo ($val['art_id']); ?>" class="fl"><?php echo ($val['art_title']); ?></a><span class="fr"><?php echo (date("Y-m-d",$val['art_addtime'])); ?></span>
									</div>
									<p>
										
									 <?php  $str =stripslashes($val['art_content']); echo htmlspecialchars_decode($str); ?>	
									</p>
								</div>
							</li><?php endforeach; endif; ?>
					</ul>
					<div class="page_turn">
						<a href="/index.php/Homen/News/index/p/<?php if($_GET['p']-1>0){echo $_GET['p']-1;}else{echo 1;} ?>">Pre</a>
						<a href="/index.php/Homen/News/index/p/1">1</a>
						<a href="/index.php/Homen/News/index/p/2">2</a>
						<span>...</span>
						<a href="/index.php/Homen/News/index/p/<?php if($page>3){echo $page-2;}else{echo 4;} ?>"><?php if($page>3){echo $page-2;}else{echo 4;} ?></a>
						<a href="/index.php/Homen/News/index/p/<?php if($page>4){echo $page-1;}else{echo 5;} ?>"><?php if($page>4){echo $page-1;}else{echo 5;} ?></a>
						<a href="/index.php/Homen/News/index/p/<?php if($_GET['p']+1>$page){echo $page;}else{echo $_GET['p']+1;} ?>">Next</a>
						<a href="/index.php/Homen/News/index/p/<?php echo ($page); ?>">Last</a>
					</div>
				</div>
			</div>
		</div>
