    ...
    <div class="banner">
      ...
      <div class="slide_nav"><span class="on"></span><span></span><span></span><span></span><span></span></div>
		...
		<div class="center-block">
			<div class="location">Current location：<a href="/index.php/Homen/Index">Home</a>&nbsp;&gt;&gt;&nbsp;<span>Online message</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">Navigation</li>
						<li class="li"><a href="/index.php/Homen/Contact/index">Contact Us</a></li>
						<li class="li"><a href="/index.php/Homen/Contact/message">Online message</a></li>
					</ul>
				...
				<div class="right fr">
					<div class="title cl">
						<span class="fl">Online message</span>
						<a href="" class="fr">MORE&gt;&gt;</a>
					</div>
					<h4>Thank you for your valuable advice</h4>
					<form action="" method="post">
						<textarea placeholder="Please leave your comments and suggestions here!" name="content"></textarea>
