    ...
    <div class="banner">
      ...
      <div class="slide_nav"><span class="on"></span><span></span><span></span><span></span><span></span></div>
		...
		<div class="center-block">
			<div class="location">Current location：<a href="/index.php/Homen/Index">Home</a>&nbsp;&gt;&gt;&nbsp;<span>Sunday industry</span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">Navigation</li>
						<?php if(is_array($result)): foreach($result as $key=>$vo): ?><li class="li" style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><a href="/index.php/Homen/Branch/detail/id/<?php echo ($vo['w_id']); ?>" ><?php echo ($vo['w_name']); ?></a></li><?php endforeach; endif; ?>
				...
				<div class="right fr">
					<div class="title cl">
						<span class="fl">Branch Company</span>
						<a href="" class="fr">MORE&gt;&gt;</a>
					</div>
					<div class="branch_list cl">
						<?php if(is_array($result)): foreach($result as $key=>$val): ?><a href="/index.php/Homen/Branch/detail/id/<?php echo ($val['w_id']); ?>" class="fl">
							<div class="pic"><div><img class="adapt" src="<?php echo ($val['w_thumb']); ?>"/></div></div>
							<p><?php echo ($val['w_name']); ?></p>
						</a><?php endforeach; endif; ?>
						<!--<a href="" class="fl">
							<div class="pic"><div><img class="adapt" src="/Public/Home/images/logo.jpg"/></div></div>
							<p>重庆森迪安防产业发展有限公司</p>
						</a>
						<a href="" class="fl">
							<div class="pic"><div><img class="adapt" src="/Public/Home/images/9.jpg"/></div></div>
							<p>重庆森迪赛斯姆安防设备有限公司</p>
						</a>
						<a href="" class="fl">
							<div class="pic"><div><img class="adapt" src="/Public/Home/images/10.jpg"/></div></div>
							<p>北京森迪时代安防技术有限公司</p>
						</a>
						<a href="" class="fl">
							<div class="pic"><div><img class="adapt" src="/Public/Home/images/logo.jpg"/></div></div>
						...
						<a href="" class="fl">
							<div class="pic"><div><img class="adapt" src="/Public/Home/images/11.jpg"/></div></div>
							<p>重庆史迪沃物业管理有限公司</p>
						</a>-->
					</div>
				</div>
