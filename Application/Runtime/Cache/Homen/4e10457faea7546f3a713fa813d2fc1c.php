      ...
      <div class="slide_nav"><span class="on"></span><span></span><span></span><span></span><span></span></div>
		...
		<div class="center-block">
			...
			<div class="main_section cl">
				...
				<div class="right fr">
					<div class="title cl">
						<span class="fl"><?php echo ($result2['w_name']); ?></span>
						<a href="" class="fr">MORE&gt;&gt;</a>
					</div>
					<div class="branch_list cl">
						<img src="<?php echo ($result2['w_thumb']); ?>" alt="" style="margin: 0 auto;width: 360px;max-height: 260px;margin-bottom: 20px;"/>
					  <p style="word-spacing:4;font-size: 14px;color: #545454;line-height: 24px;text-indent: 24px;padding: 5px 0;">
                   
                                 	<?php  $str =stripslashes($result2['w_content']); echo htmlspecialchars_decode($str); ?>
					  </p>
