	...
	<body>
		...
		<div class="head_bottom">
			<div class="center-block cl">
				<a href="/index.php/Home2/Index/index" class="logo fl">
					<img src="/Public/Home/images/10.jpg"/ height="95px;"  style="margin-top: -20px;"></a>
				<ul class="nav fr cl">
		...
		<div class="center-block">
			<div class="main block1 cl">
				<div class="left fl">
					<div class="title"><span class="span1"><a href="/index.php/Home2/Walkto/index">公司简介</a></span><span class="span2">Company profile</span></div>
				...
				<div class="center fl">
					<div class="title"><span class="span1"><a href="/index.php/Home2/News/index">新闻中心</a></span><span class="span2">News Center</span></div>
					<div class="div1 cl">
						<div class="l fl"><img class="adapt" src="<?php echo ($news1['art_thumb']); ?>"/ width="127px" height="88"></div>
						<div class="r fl">
							<a href="/index.php/Home2/News/details/id/<?php echo ($news1['art_id']); ?>" class="t"><?php echo ($news1['art_title']); ?></a>
					...
					<ul>
						<?php if(is_array($news)): foreach($news as $key=>$news): ?><li><a href="/index.php/Home2/News/details/id/<?php echo ($news['art_id']); ?>">
							<?php  $str =stripslashes($news['art_content']); echo htmlspecialchars_decode($str); ?>
						</a></li><?php endforeach; endif; ?>
					</ul>
				</div>
				<div class="right fl">
					<div class="title"><span class="span1"><a href="/index.php/Home2/Contact/index">联系方式</a></span><span class="span2">Contact information</span></div>
			...
			<div class="main block2">
				<div class="title"><span class="span1"><a href="/index.php/Home2/product/index">相关产品</a></span><span class="span2">Related products</span></div>
				<div class="marquee">
					<ul class="cl">
						<?php if(is_array($pro)): foreach($pro as $key=>$vo): ?><li><a href="/index.php/Home2/Product/details/id/<?php echo ($vo['pro_id']); ?>" >
			...
			<div class="main block3 cl">
				<div class="left fl">
					<div class="title cl">
						<span class="span1 fl"><a href="/index.php/Home2/News/index/id/4">推荐信息</a></span>
						<span class="span2 fl">Recommended information</span>
						<a href="/index.php/Home2/News/index/id/4" class="more fr">更多》</a>
					</div>
					<div class="pic"><img class="adapt" src="/Public/Home/images/20.jpg"/></div>
					<?php if(is_array($art)): foreach($art as $key=>$art): ?><a href="/index.php/Home2/News/details/id/<?php echo ($art['art_id']); ?>"><?php echo ($art['art_title']); ?></a><?php endforeach; endif; ?>
				</div>
				<div class="right fr">
					<div class="title cl">
						<span class="span1 fl"><a href="/index.php/Home2/News/index/id/5">服务介绍</a></span>
						<span class="span2 fl">Service Introduction</span>
						<a href="/index.php/Home2/News/index/id/5" class="more fr">更多》</a>
					</div>
					<ul>
						<?php if(is_array($serverce)): foreach($serverce as $key=>$se): ?><li class="cl">
							...
							<div class="info fr">
								<a href="/index.php/Home2/News/details/id/<?php echo ($se['art_id']); ?>"><?php echo ($se['art_title']); ?></a>
								<p>
