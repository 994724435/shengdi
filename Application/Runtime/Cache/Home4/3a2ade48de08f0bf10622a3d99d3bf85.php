...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="/index.php/Home4/Index"><span style="font-weight: bold;color: #000000;">返回首页</span></a>&nbsp;&gt;&gt;&nbsp;<span>人才招聘</span>&nbsp;&gt;&gt;&nbsp;<span><?php echo $_GET['title'] ?></span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">导航</li>
						<li class="li"><a href="/index.php/Home4/Work/index/title/社会招聘">社会招聘</a></li>
						<li class="li"><a href="/index.php/Home4/Work/index/title/校园招聘">校园招聘</a></li>
					</ul>
					<!--<p>广告位</p>
					...
					<div class="lzx">
					   <div class="lbl">
						...
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><ul class="zplb">
						 ...
						 <li><a href="/index.php/Home4/Work/details/id/<?php echo ($vo['w_id']); ?>">查看详情</a></li>
						</ul><?php endforeach; endif; ?>
						
				     </div>
					<div class="page_turn">
						<a href="/index.php/Home4/Work/index/p/<?php if($_GET['p']-1<=0){echo 1;}else{echo $_GET['p']-1;} ?>">上一页</a>
						<a href="/index.php/Home4/Work/index/p/1">1</a>
						<!--<a href="">2</a>
						<a href="">3</a>
						<a href="">4</a>-->
						
						<span>...</span>
						<a href="/index.php/Home4/Work/index/p/<?php echo ($page); ?>"><?php echo ($page); ?></a>
						<a href="/index.php/Home4/Work/index/p/<?php if($_GET['p']+1<$page){echo $_GET['p']+1;}else{echo $page;} ?>">下一页</a>
						<a href="/index.php/Home4/Work/index/p/<?php echo ($page); ?>">尾页</a>
					</div>
					</div>
				</div>
			</div>
