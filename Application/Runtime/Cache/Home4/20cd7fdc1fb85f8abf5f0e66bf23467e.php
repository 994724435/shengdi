...
<html>
	...
	<body>
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="/index.php/Home4/Index/index"><span style="font-weight: bold;color: #000000;">返回首页</span></a>&nbsp;&gt;&gt;&nbsp;<span>产品介绍</span><span>&nbsp;&gt;&gt;&nbsp;<?php echo ($catename); ?></span></div>
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">导航</li>
					<?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><li class="li"><a href="/index.php/Home4/Product/index/id/<?php echo ($vo['cate_id']); ?>"><?php echo ($vo['cate_name']); ?></a></li><?php endforeach; endif; ?>	
				...
				<div class="right fr">
						...
						<?php if(is_array($list)): foreach($list as $key=>$list): ?><li class="cl">
							...
							<div class="r fl">
								<div class="title_bar cl">
									<a href="/index.php/Home4/Product/details/id/<?php echo ($list['pro_id']); ?>" class="fl" style="font-weight: bold;"><?php echo ($list['pro_name']); ?></a><span class="fr"><?php echo (date('Y-m-d',$pro["pro_addtime"])); ?></span>
								</div>
								<p>
					...
					<div class="page_turn">
						<a href="/index.php/Home4/Product/index/p/<?php if($_GET['p']-1<=0){echo 1;}else{echo $_GET['p']-1;} ?>">上一页</a>
						<a href="/index.php/Home4/Product/index/p/1">1</a>
						<a href="/index.php/Home4/Product/index/p/2">2</a>				
						<span>...</span>
						<a href="/index.php/Home4/Product/index/p/<?php echo ($page); ?>"><?php if($page>2){echo $page;}else{echo '暂无';} ?></a>
						<a href="/index.php/Home4/Product/index/p/<?php if($_GET['p']+1<$page){echo $_GET['p']+1;}else{echo $page;} ?>">下一页</a>
						<a href="/index.php/Home4/Product/index/p/<?php echo ($page); ?>">尾页</a>
					</div>
				</div>
			</div>
		</div>
