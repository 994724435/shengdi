...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">公司管理</a><a href="<?php echo U('/index.php/Adminen4/Link/words_link');?>" class="home_pass">公司列表</a><a class="home_now">公司修改</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
        <div class="edit_title"><div class="col_left f">名称</div><div class="col_right f"><input type="text" name="title" class="title_text" value="<?php echo ($result['w_name']); ?>"/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 -->
        <!-- 文章缩略图 -->
        <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src="<?php echo ($result['w_thumb']); ?>"> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" onchange="previewImage(this)" name="thumb"/></div> </div> </div> </div> <div class="clear"></div>
        <!-- 文章提交者 -->
        <!-- 文章详情 -->
        <div class="article_detail"><div class="col_left f d_bottom">文章详情</div><div class="col_right f d_bottom"><div class="detail_edit"> <?php echo $htmlData; ?> <textarea name="content1" class="textarea">
                      	<?php  $str =stripslashes($result['w_content']); echo htmlspecialchars_decode($str); ?>        </textarea> </div></div></div> <div class="clear"></div>
        <!-- 提交或者取消 -->
