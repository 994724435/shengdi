...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">广告管理</a><a href="" class="home_pass">广告列表</a><a class="home_now">广告修改</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
        <div class="edit_title"><div class="col_left f">名称</div><div class="col_right f"><?php echo ($data['link_name']); ?><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 -->
        <!-- 文章缩略图 -->
        <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src='<?php echo ($data['link_url']); ?>'> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" onchange="previewImage(this)" name="thumb"/></div> </div> </div> </div> <div class="clear"></div>
        <!-- 文章提交者 -->
