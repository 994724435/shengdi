...
<div class="top">
  <div class="logo">网站英文版后台管理系统</div>
  <div class="admin">
...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">投资管理</a><a href="/index.php/Adminen1/Invest/index" class="home_pass">投资列表</a><a class="home_now">投资添加</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
        <div class="edit_title"><div class="col_left f">标题</div><div class="col_right f"><input type="text" name="title" class="title_text" value="<?php echo ($data['i_title']); ?>"/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 -->
             <div class="edit_title"><div class="col_left f">作者</div><div class="col_right f"><input type="text" name="author" class="title_text" value="<?php echo ($data['i_place']); ?>"/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 -->        
        <div class="choose_sort same_height"> 
        	<div class="col_left f">选择分类</div> <div class="col_right f">
        		<select class="sort f" name="cate" id="cate"> 
        				<option value="<?php echo ($data['i_class']); ?>"><?php echo ($data['i_class']); ?></option> 
        				<option value="投资项目">投资项目</option> 
        				<option value="优惠政策">优惠政策</option> 
        			 </select>
        			
        			<div class="f">
        				<input type="text" class="newsort" style="width:120px;">
        					<label class="newsorttext">新建分类</label></div> <div class="clear"></div> </div> </div> 
        					<div class="clear"></div>
        <!-- 文章缩略图 -->
        <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src='<?php echo ($data['i_thumb']); ?>'> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" onchange="previewImage(this)" name="thumb"/></div> </div> </div> </div> <div class="clear"></div>
        <div class="article_detail"><div class="col_left f d_bottom">文章详情</div><div class="col_right f d_bottom"><div class="detail_edit"> <?php echo $htmlData; ?> <textarea name="content1" class="textarea">
        	<?php  $str =stripslashes($data['i_content']); echo htmlspecialchars_decode($str); ?>
