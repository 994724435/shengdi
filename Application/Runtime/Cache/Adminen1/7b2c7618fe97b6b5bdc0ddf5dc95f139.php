...
<div class="rightfix">
    <a href="<?php echo U('/index.php/Adminen1/Index/index');?>" class="home1"></a><a class="home_pass" >投资列表</a><a class="home_now" href="/index.php/Adminen1/Invest/add">添加投资</a>
    <div class="clear"></div>
        ...
        <form action="" style="margin:20px 20px;" method="post">
          <table> 
            ...
            <?php if(is_array($res)): foreach($res as $key=>$value): ?><tr class="table_list"> 
                ...
                <td div class="table2"> 
                  <?php if($value['art_isshow'] == 1): else: endif; ?> <a href="<?php echo U('/index.php/Adminen1/Invest/editor',array('id'=>$value['i_id']));?>" class="aa2">编辑</a> / 
                        /  <a href="<?php echo U('/index.php/Adminen1/Invest/delete',array('id'=>$value['i_id']));?>" class="aa3">删除</a>
