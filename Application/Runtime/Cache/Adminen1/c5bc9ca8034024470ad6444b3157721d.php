...
<style> #preview{width:289px;height:93px;border:1px solid #cfcfcf;overflow:hidden;text-align: center;} #imghead {filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=image);width:114px;height:104px;margin-top: 0;} .fileimg input{width: 100%; height: 55px; cursor: pointer; opacity: 0; filter: alpha(opacity=0); } </style>
 <div class="rightfix">
 <!-- 头信息 -->
  <a class="home1"></a><a class="home_pass">文章管理</a><a href="/index.php/Adminen1/Article/index" class="home_pass">文章列表</a><a class="home_now">文章编辑</a>
  <div class="clear"></div>
  ...
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <div class="edit_title"> <div class="col_left f">标题</div> <div class="col_right f"> <input type="text" name="title" class="title_text" value="<?php echo ($result['ast_acate']); ?>"/> </div> <div class="clear"></div> </div> <div class="clear"></div>
   		   <!-- 选择文章分类 -->
   		   <!-- 文章缩略图 -->
        <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src=''> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" onchange="previewImage(this)" name="thumb"/></div> </div> </div> </div> <div class="clear"></div>
        <!-- 文章提交者 -->   
        <div class="article_detail"> <div class="col_left f d_bottom">文章详情</div> <div class="col_right f d_bottom"> <div class="detail_edit"> <?php echo $htmlData; ?> <textarea name="content1" class="textarea">
        	...
        	<?php  $str =stripslashes($result['ast_acontent']); echo htmlspecialchars_decode($str); ?>
