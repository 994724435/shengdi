...
<html>
	...
	<body>
		...
		<div class="head_bottom">
			<div class="center-block cl">
				<a href="/index.php/Home5/Index/index" class="logo fl">
					<img src="/Public/Home/images/1314.png"/ width="110px;" style="margin-top: -20px;"></a>
				<ul class="nav fr cl">
		...
		<div class="center-block">
			<div class="location">当前位置：<a href="/index.php/Home5/Index">
			...
			<div class="main_section cl">
				<div class="left fl">
					<ul class="menu">
						<li class="tit">导航</li>
						<?php if(is_array($result)): foreach($result as $key=>$vo): ?><li class="li"><a href="/index.php/Home5/Walkto/index/id/<?php echo ($vo['ast_aid']); ?>"><?php echo ($vo['ast_acate']); ?></a></li><?php endforeach; endif; ?>
					</ul>
					<!--<p>广告位</p>
