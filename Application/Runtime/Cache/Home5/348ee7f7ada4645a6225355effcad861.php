		...
		<div class="center-block">
			...
			<div class="main_section cl">
				...
				<div class="right fr">
					...
					<a href="/index.php/Home5/News/details/id/<?php echo ($result1['art_id']); ?>" class="prev">上一篇：<?php if($result1['art_title']){echo $result1['art_title'];}else{echo "没有了";} ?>...</a>
					<a href="/index.php/Home5/News/details/id/<?php echo ($result2['art_id']); ?>" class="next">下一篇：<?php if($result2['art_title']){echo $result2['art_title'];}else{echo "没有了";} ?></a>
				</div>
			</div>
		</div>
				<div class="footer">
