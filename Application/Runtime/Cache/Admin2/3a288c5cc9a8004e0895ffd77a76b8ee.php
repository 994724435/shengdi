...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">公司管理</a><a href="<?php echo U('/index.php/Admin2/Link/words_link');?>" class="home_pass">公司列表</a><a class="home_now">公司添加</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="<?php echo U('/index.php/Admin2/Article/add');?>" method='post' enctype="multipart/form-data">
