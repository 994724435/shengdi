...
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">森迪产业</a><a href="/index.php/Adminen3/Link/add" class="home_right">添加分公司</a>
  <div class="clear"></div>
  <div class="article_list">
    ...
    <?php if(is_array($result)): foreach($result as $key=>$val): ?><div class="table_list">
        <div class="wz_list">
          ...
          <div class="wz_table3">
          	<a class="aa1" href="<?php echo U('/index.php/Adminen3/Link/words_editor',array('id'=>$val['w_id']));?>">修改</a>||
          	<a class="aa1" href="<?php echo U('/index.php/Adminen3/Link/words_del',array('id'=>$val['w_id']));?>">删除</a></div>
        </div>
      </div>
