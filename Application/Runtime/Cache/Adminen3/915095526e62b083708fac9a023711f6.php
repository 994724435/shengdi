...
<div class="rightfix">
    <a href="<?php echo U('/index.php/Adminen3/Index/index');?>" class="home1"></a><a class="home_pass" >投资列表</a><a class="home_now" href="/index.php/Adminen3/Invest/add">添加投资</a>
    <div class="clear"></div>
    <div class="article_list" style="width:980px;">
        ...
        <div class="title">
          ...
          <div id="dd" class="wrapper-dropdown-3" tabindex="1">
            ...
            <ul class="dropdown"> 
              <li><a onclick="javascript:window.location.href=''">未分类</a></li> 
              <?php if(is_array($acate)): foreach($acate as $key=>$value): ?><li><a ><?php echo ($value["cate_name"]); ?></a></li><?php endforeach; endif; ?> 
            </ul> 
          </div> 
        ...
        <form action="" style="margin:20px 20px;" method="post">
          <table> 
            ...
            <div class="clear"></div> 
            <?php if(is_array($res)): foreach($res as $key=>$value): ?><tr class="table_list"> 
                <td class="table4"><?php echo ($value["i_title"]); ?></td> 
                <td div class="table2"> 
                  <?php if($value['art_isshow'] == 1): else: endif; ?> <a href="<?php echo U('/index.php/Adminen3/Invest/editor',array('id'=>$value['i_id']));?>" class="aa2">编辑</a> / 
                        /  <a href="<?php echo U('/index.php/Adminen3/Invest/delete',array('id'=>$value['i_id']));?>" class="aa3">删除</a>
                        
                </td> 
                <!--<td class="table3"><input type="text" value="<?php echo ($value["art_order"]); ?>" artID="<?php echo ($value["art_id"]); ?>" class="order"/></td>--> 
                <td class="table3"><?php echo ($value["i_class"]); ?></td> 
              </tr> 
              <div class="clear">
            </div><?php endforeach; endif; ?> 
        </table> 
