...
<!--文章编辑-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass" href="/index.php/Adminen3/Product/index">产品管理</a><a class="home_now">添加产品</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="<?php echo U('/index.php/Adminen3/Product/add');?>" method='post' enctype="multipart/form-data">
    <div class="article_edit_list">
      ...
      <div class="clear"></div>
        ...
        <div class="clear"></div>
        <div class="public same_height"><div class="col_left f">日期</div><div class="col_right f"><input type="text"  class="title_text" readonly="true" name="time" value="<?php echo (date("Y-m-d",$time)); ?>" /></div><div class="clear"></div></div>
        <div class="clear"></div>
...
if(adm_power.indexOf('添加产品') === -1){
  ...
  $("#cate").change(function(){
    var pid=$(this).val();
    if(pid){
      $.post('/index.php/Adminen3/Product/cateAjax',{'pid':pid},function(data){
  ...
  $(".newsorttext").click(function(){
    ...
    var cid = $("#cate").val();
    $.post('/index.php/Adminen3/Product/sortAjax',{'sort':sort,'cid':cid},function(data){
        if(!cid){
