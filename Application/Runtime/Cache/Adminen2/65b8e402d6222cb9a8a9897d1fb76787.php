...
<div class="rightfix">
    <a href="<?php echo U('/index.php/Adminen2/Index/index');?>" class="home1"></a><a class="home_pass">招聘管理</a><a class="home_now">招聘列表</a>
    <div class="clear"></div>
        ...
        <form action="" style="margin:20px 20px;" method="post">
          <table> 
            ...
            <?php if(is_array($result)): foreach($result as $key=>$value): ?><tr class="table_list"> 
                <td class="table4"><?php echo ($value['w_name']); ?></td> 
                <td div class="table2"> 
                <a href="<?php echo U('/index.php/Adminen2/Join/editor',array('id'=>$value['w_id']));?>" class="aa2">编辑</a> /  
                <a href="<?php echo U('/index.php/Adminen2/Join/delete',array('id'=>$value['w_id']));?>" class="aa3">删除</a>
                </td> 
                <td class="table3"><?php echo ($value['w_cateid']); ?></td> 
              </tr> 
              <div class="clear">
            </div><?php endforeach; endif; ?> 
        </table> 
