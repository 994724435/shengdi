...
<!--文章编辑-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass" href="/index.php/Adminen2/Product/index">产品管理</a><a class="home_now">添加产品</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="<?php echo U('/index.php/Adminen2/Product/add');?>" method='post' enctype="multipart/form-data">
...
if(adm_power.indexOf('添加产品') === -1){
  ...
  $("#cate").change(function(){
    var pid=$(this).val();
    if(pid){
      $.post('/index.php/Adminen2/Product/cateAjax',{'pid':pid},function(data){
  ...
  $(".newsorttext").click(function(){
    ...
    var cid = $("#cate").val();
    $.post('/index.php/Adminen2/Product/sortAjax',{'sort':sort,'cid':cid},function(data){
        if(!cid){
