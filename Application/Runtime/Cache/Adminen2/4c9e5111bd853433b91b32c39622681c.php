...
<div class="rightfix">
  <a class="home1"></a><a class="home_pass"></a><a class="home_now">企业简介</a>
  <div class="clear"></div>
  <div class="menberlist">
  	...
  	<form action="" method="post">
  		...
  		<div class="clear"></div>
      <?php if(is_array($result)): foreach($result as $key=>$val): ?><div class="menber_row">

  			<div class="menber_col5 f menber_col"><?php echo ($val['ast_acate']); ?></div>
  			<div class="menber_col6 f menber_col">--  -- -- </div>
  			<div class="menber_col5 f menber_col">
  				<p class="caozuo_con">
  					 <a href="/index.php/Adminen2/Member/editor/id/<?php echo ($val['ast_aid']); ?>">修改</a>
...
<script type="text/javascript">
    ...
    if(adm_power.indexOf('会员列表') === -1){
      	...
      	$('.stop_use,.enable_use').click(function(){
			...
			$.post('/index.php/Adminen2/Member/state',{'id':id},function(data){
				if(data.res){
