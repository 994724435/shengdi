...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">首页管理</a><a class="home_now">公司简介</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <table border="1" cellpadding="5" cellspacing="0" bordercolor="#ddd" width="830" height="300" style="margin-left: 120px;text-align: center;">
        	<tr>
        		<td><img src="<?php echo ($result['c_thumb']); ?>" width="60%"/></td>
        	
        	</tr>
        	<tr>
        		<td><a href="/index.php/Adminen2/Link/pic/id/c_thumb">图片修改</a></td>
        ...
        <div class="article_detail"><div class="col_left f d_bottom">文章详情</div><div class="col_right f d_bottom"><div class="detail_edit"> <?php echo $htmlData; ?> <textarea name="content1" class="textarea">        	
        	<?php  $str =stripslashes($result['c_content']); echo htmlspecialchars_decode($str); ?>
