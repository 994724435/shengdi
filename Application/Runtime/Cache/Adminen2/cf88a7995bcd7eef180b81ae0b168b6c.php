...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">公司管理</a><a class="home_now">联系添加</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
               <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src='<?php echo ($res['c_content']); ?>'> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" name="thumb" onchange="previewImage(this)"   /></div> </div> </div> </div> <div class="clear"></div>
        <!-- 文章提交者 -->         
<div class="edit_title"><div class="col_left f">住址</div><div class="col_right f"><input type="text" name="place" class="title_text" value="<?php echo ($res['c_name']); ?>"/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 -->
       
        <div class="submit_person same_height"><div class="col_left f">电 话：</div><div class="col_right f"><input type="text" name="tel" class="title_text" value="<?php echo ($res['c_thumb']); ?>" /></div><div class="clear"></div></div> <div class="clear"></div>
         <!-- 文章发布日期 -->
        <div class="submit_person same_height"><div class="col_left f">网 址：</div><div class="col_right f"><input type="text" name="web" class="title_text" value="<?php echo ($res['c_thumb1']); ?>" /></div><div class="clear"></div></div> <div class="clear"></div>
         <!-- 文章发布日期 --> 
        <div class="public same_height"><div class="col_left f">E-mail：</div><div class="col_right f"><input type="text"  class="title_text"  name="email" value="<?php echo ($res['c_thumb2']); ?>" /></div><div class="clear"></div></div> <div class="clear"></div>
