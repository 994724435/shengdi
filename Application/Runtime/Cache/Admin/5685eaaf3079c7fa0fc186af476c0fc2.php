    ...
    <form action="" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        <table border="1" cellpadding="5" cellspacing="0" bordercolor="#ddd" width="830" height="300" style="margin-left: 120px;text-align: center;">
        	<tr>
        		<td><img src="<?php echo ($result['c_thumb']); ?>" width="90%"/></td>
        		<td><img src="<?php echo ($result['c_thumb1']); ?>" width="90%"/></td>
        		<td><img src="<?php echo ($result['c_thumb2']); ?>" width="90%"/></td>
        	</tr>
        	<tr>
        		<td><a href="/index.php/Admin/Link/pic/id/c_thumb">修改</a></td>
        		<td><a href="/index.php/Admin/Link/pic/id/c_thumb1">修改</a></td>
        		<td><a href="/index.php/Admin/Link/pic/id/c_thumb2">修改</a></td>
        	</tr>        	
        </table>
