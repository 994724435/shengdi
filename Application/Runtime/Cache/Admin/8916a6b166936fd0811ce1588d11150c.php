...
<div class="rightfix">
  ...
  <div style="width:1072px;margin-left:5px;">
    <form action="<?php echo U('/index.php/Admin/Invest/add');?>" method='post' enctype="multipart/form-data">
      <div class="article_edit_list">
        ...
        <!-- 文章分类 -->
            <div class="edit_title"><div class="col_left f">作者</div><div class="col_right f"><input type="text" name="author" class="title_text" value=""/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 --> 
