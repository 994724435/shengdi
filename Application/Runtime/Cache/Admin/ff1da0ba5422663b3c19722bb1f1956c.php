...
<div class="top">
  ...
  <div class="welc">您好，欢迎您登录网站后台管理平台</div>
   <div class="welc"><a href="/index.php/Adminen/Invest/index" style="color: red;">切换到英文版</a></div>
</div>
<div class="clear"></div>
<div class="leftfix">
...
<div class="rightfix">
  ...
  <div class="clear"></div>
    ...
    <div class="article_edit_list">
      ...
      <!-- 产品缩略图 -->
      <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src='<%=request.getContextPath()%>/images/defaul.jpg'> <img src='/Public/Admin/images/thumbnail_close.png' class='thumbnail_close'> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" onchange="previewImage(this)" name="thumb"/></div> </div> </div> <div class="clear"></div> </div> <div class="clear"></div>
      <!-- 产品是否显示 -->
