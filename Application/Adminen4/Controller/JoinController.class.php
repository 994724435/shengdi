...
//			print_r($_POST);die;
			...
			if($res||$result){
				echo "<script>window.location.href='/index.php/Adminen4/Join/contact';</script>";
			}else{echo "<script>alert('更新失败');window.location.href='/index.php/Adminen4/Join/contact';</script>";}
		}
    ...
    public function delete(){
		...
		if($res){
				echo "<script>window.location.href='/index.php/Adminen4/Join/index';</script>";
			}else{echo "<script>alert('删除失败');window.location.href='/index.php/Adminen4/Join/index';</script>";}
    ...
    public function editor(){
		...
		if($_POST){
			...
			if($res){
				echo "<script>window.location.href='/index.php/Adminen4/Join/index';</script>";
			}else{echo "<script>alert('更新失败');window.location.href='/index.php/Adminen4/Join/index';</script>";}
		}
    ...
    public function add(){
		if($_POST){
			...
			if($res){
				echo "<script>window.location.href='/index.php/Adminen4/Join/index';</script>";
			}else{echo "<script>alert('添加失败');window.location.href='/index.php/Adminen4/Join/index';</script>";}
		}
        $this->display();
    }
