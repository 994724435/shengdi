...
class MemberController extends CommonController {
    ...
    public function editor(){
		...
		if($_POST){
			...
			if($res||$resu){
				 echo "<script>window.location.href='/index.php/Admin4/Member/index';</script>";exit;
			}else{
				 echo "<script>alert('更新失败');window.location.href='/index.php/Admin4/Member/index';</script>";exit;
			}
		}
