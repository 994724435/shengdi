...
class InvestController extends CommonController {
    ...
    public function delete(){
    	$id = I('get.id');
		if($id==1||$id==2){
			 echo "<script>alert('栏目项不能删除');window.location.href='/index.php/Adminen1/Invest/index';</script>";exit;
		}
        $invest =M('Investen1');
        ...
        if($date){
            echo "<script>window.location.href='/index.php/Adminen1/Invest/index';</script>";exit;
        }else{
            echo "<script>alert('删除失败');window.location.href='/index.php/Adminen1/Invest/index';</script>";exit;
        }
    }
	...
	public function add(){
		...
		if($res||$result){
			echo "<script>window.location.href='/index.php/Adminen1/Invest/index';</script>";
		}else{
			echo "<script>window.location.href='/index.php/Adminen1/Invest/index';</script>";
		}			
			 }	
