...
class MessageController extends CommonController {
    ...
    public function delete(){
        ...
        if($res){
            echo "<script>window.location.href='/index.php/Adminen3/Message/index';</script>";die;
        }else{
            echo "<script>alert('删除失败');window.location.href='/index.php/Adminen3/Message/index';</script>";exit;
        }
    }
