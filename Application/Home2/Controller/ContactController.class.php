...
class ContactController extends CommonController {
	...
	public function message(){
		if($_POST['content']){
			...
			if($result){
				echo "<script>alert('提交成功');window.location.href='/index.php/Home2/Contact/message';</script>";exit;
			}else{
				echo "<script>alert('提交失败');window.location.href='/index.php/Home2/Contact/message';</script>";exit;
			}
		}		
		$this->display();
	}
