...
class UserController extends Controller {
            ...
            if(!$res){
	            ...
	            if($admin_id){
	                if($admin_pswd == $admin_id['admin_password']){
	                    ...
	                    echo "<script>window.location.href='/index.php/Admin3/index';</script>";
	                }else{
    ...
    public function logOut(){
        ...
        echo "<script>window.location.href = '/index.php/Admin3/User/login';</script>";
    }
    ...
    public function del(){
        ...
        if($res){
            echo "<script>window.location.href = '/index.php/Admin3/Index/index';</script>";
        }
        die;
    }
