...
class UserController extends Controller {
            ...
            if(!$res){
	            ...
	            if($admin_id){
	                if($admin_pswd == $admin_id['admin_password']){
	                    ...
	                    echo "<script>window.location.href='/index.php/Admin2/index';</script>";
	                }else{
    ...
    public function logOut(){
        ...
        echo "<script>window.location.href = '/index.php/Admin2/User/login';</script>";
    }
    ...
    public function del(){
        ...
        if($res){
            echo "<script>window.location.href = '/index.php/Admin2/Index/index';</script>";
        }
        die;
    }
